...
public:
  ...
  explicit ScaledDotProductAttention(bool is_causal=false,
                                     double dropout_p=0.0,
                                     std::optional<double> scale=std::nullopt,
                                     bool enable_gqa=false)
  : Function(kType), is_causal_(is_causal), dropout_p_(dropout_p),
    scale_(std::move(scale)), enable_gqa_(enable_gqa) {}
